			...
			<div class="col-sm-4 col-md-4 user-details">
				<div class="user-image">
					<img src="${otherUser.profile.image}"
						title="${otherUser.profile.firstName}" class="img-rounded"
						height="300" width="300">
				</div>
				<div class="user-info-block">
					<div class="user-heading">
						<h3>${otherUser.profile.firstName}
							${otherUser.profile.lastName}</h3>
						<span class="help-block">${otherUser.profile.location.city},
							${otherUser.profile.location.state}</span> <span class="help-block">${otherUser.profile.location.country}</span>
					</div>
					<ul class="navigation">
