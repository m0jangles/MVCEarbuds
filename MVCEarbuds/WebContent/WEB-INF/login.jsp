...
<style>
body {
background-image: url("https://cdn.pixabay.com/photo/2016/12/01/07/30/music-1874621_1280.jpg");
}
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<form:form class="navbar-form navbar-right" method="POST"
					...
					<button type="submit" class="btn btn-outline-dark btn-std">Sign In</button>
				</form:form>
				<%--End Login Form --%>
			</div>
		</div>
